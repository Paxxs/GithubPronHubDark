...
function execute(request) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        if (request.isAborted) {
            ...
            reject(new index_1.httpclient.Response(request, 0, 'OK', {}, null));
        }
        else {
            ...
            var buildResponseAndUpdateRequest_1 = function (req) {
                ...
                return new index_1.httpclient.Response(request, req.status, req.statusText, parseResponseHeaders_1(req), responseBody);
            };
